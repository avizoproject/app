...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Modify a reservation</title>
    </head>
    <body>
        <div class="page">
                ...
                <md-content>
                  <div class="md-content__body">
                    <form role="form">
                      ...
                      <md-checkbox required class="md-primary" aria-label="Checkbox 1">
                        Check me out
                      </md-checkbox>
                      <md-button class="btn-width-medium md-raised md-primary">Submit</md-button>
                    </form>
                  </div>
                </md-content>
